...
class MeetingSetupEvent with _$MeetingSetupEvent {
  ...
  const factory MeetingSetupEvent.changedWaitingRoom(bool value) =
      _ChangedWaitingRoom;
  ...
  const factory MeetingSetupEvent.changedAllowRecord(bool value) =
      _ChangedAllowRecord;
  const factory MeetingSetupEvent.changedAllowChat(bool value) =
      _ChangedAllowChat;
  const factory MeetingSetupEvent.changedLimitUser(int number) =
      _ChangedLimitUser;
  const factory MeetingSetupEvent.createMeeting({String? title}) =
      _CreateMeeting;
}
